...
<head>
  ...
  <style>
    .form-control {
      @apply input input-bordered w-full mb-4 bg-white text-black; /* Make the background white and text black */
    }
...
<head>
  ...
  <div class="container mx-auto p-6">
    <h3 class="text-center text-2xl font-bold mb-6">Add Organization</h3>
    <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-md">
      <form action="org_connection.php" method="POST" onsubmit="return validateForm()">
